...
import com.example.memorypractice.app.repeat.reqdto.ReqRepeatEdit;
import com.example.memorypractice.app.repeat.reqdto.ReqRepeatTodo;
...
import com.example.memorypractice.app.repeat.service.RepeatR_Service;
import com.example.memorypractice.app.repeat.service.RepeatW_Service;
...
public class RepeatController {
    ...
    @GetMapping("/alltodo")
    public ResponseEntity<List<ResAlltodo>> resAlltodo(@AuthenticationPrincipal Long userId,
                                                 @RequestParam(required = false) LocalDate date){
        LocalDate readDate = date == null ? LocalDate.now() : date;
        return ResponseEntity.ok(repeatR_service.allTodo(userId,readDate));
    }
