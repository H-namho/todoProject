...
import com.example.memorypractice.app.todo.reqdto.ReqDeleteIds;
import com.example.memorypractice.app.todo.reqdto.ReqUpdateTodo;
import com.example.memorypractice.app.todo.reqdto.ReqWriteTodo;
import com.example.memorypractice.app.todo.resdto.ResTodo;
import com.example.memorypractice.app.todo.resdto.ResTodoList;
import com.example.memorypractice.app.todo.service.TodoR_Service;
import com.example.memorypractice.app.todo.service.TodoW_Service;
...
public class TodoController {
    ...
    public ResponseEntity<ResTodoList> readTodoList(@AuthenticationPrincipal Long userId,
        ...
        return ResponseEntity.ok(r_service.readTodoList(
                userId, completed, priority, keyword, dueDateFrom, dueDateTo, page, size));
    }
