...
public interface TodoRepository extends JpaRepository<TodoEntity,Long> {
    ...
    long countByUser_IdAndPriorityAndCompletedFalse(Long userId, TodoPriority priority);
    ...
    @Query("""
        SELECT new com.example.memorypractice.app.todo.resdto.TodayTodo(
            t.user.id,
            t.title
        )
        FROM TodoEntity t
    ...
    List<TodoEntity> findByUser_IdAndDueDate(Long userId, LocalDate dueDate);
}
