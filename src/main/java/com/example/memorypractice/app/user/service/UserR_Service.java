...
import com.example.memorypractice.app.user.reqdto.ReqLogin;
import com.example.memorypractice.app.user.resdto.ResLogin;
import com.example.memorypractice.app.user.resdto.ResProfile;
...
public class UserR_Service {
    ...
    public ResLogin refresh(String refreshToken){
        // 토큰검증
        if(!jwtProvider.vaildateToken(refreshToken) || !jwtProvider.isRefreshToken(refreshToken)){
