package com.example.memorypractice.app.user.service;

import com.example.memorypractice.app.user.reqdto.ReqPassword;
import com.example.memorypractice.app.user.reqdto.ReqSignUp;
import com.example.memorypractice.app.user.reqdto.ReqNickname;
import com.example.memorypractice.app.user.UserEntity;
import com.example.memorypractice.app.user.UserRepository;
import com.example.memorypractice.app.user.UserRole;
...
public class UserW_Service {
    ...
    public void updatePassword(ReqPassword reqPassword,Long userId){
        ...
        tokenRedisRepositry.removeRefresh(userId);
        tokenRedisRepositry.invalidateTokensIssuedBefore(userId, System.currentTimeMillis());
    }
}
